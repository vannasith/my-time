  ...
  >
    ...
    >
      ...
      ></v-select></v-col>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn x-large color="blue darken-1" @click="close">Cancel</v-btn>
              <v-btn :disabled="!valid" x-large color="success darken-1" @click="save">Save</v-btn>
            </v-card-actions>
              </v-form>
          </v-card>
        </v-dialog>
 ...
 // },
    ...
    nameRules: [
      ...
      detailRules: [
        ...
        v => (v && v.length <= 250) || 'Detail must be less than 250 characters',
      ],
    headers: [
      {text: 'Id', value: 'auto'},
      {
